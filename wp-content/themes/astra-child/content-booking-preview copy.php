<div class="booking_preview">
    ...
    <div class="boooking_details_data">
          <div><h3>Number of Rooms</h3></div>
          <div><h5>1</h5></div>
          <div><h3>Room Type</h3></div>
          <div><h5>Garden King Bungalow</h5></div>
          <div><h3>Nights Stay</h3></div>
          <div><h5>2</h5></div>
          <div><h3>Arrival Date</h3></div>
          <div><h5>Wednesday, September 1, 2021</h5></div>
          <div><h3>Departure Date</h3></div>
          <div><h5>Friday, September 3, 2021</h5></div>
    ...
    <div class="booking_add_ons">
        ...
        <div class="charges_entry">
            <span>01 September</span>
            <span>1 @ $650.00 each</span>
    ...
    <div class="booking_add_ons">
        <h3>Daily Boat Excursions $</h3>
        <div class="facilities_ct">
            <div class="facilities_img">
                 <img src="	https://www.reseze.net/cassets/mkt/1566/fcl/day.jpg">
            </div>
            <div class="facilities_data">
                <p>
                Step aboard our state-of-the-art catamaran for a day exploring the crystal-clear
                 waters and amazing wildlife of the Florida Everglades National Park 
                 and Buttonwood Sound. Price is per person. 24 Hour Cancellation Policy. 
                 *Weather Dependent
                </p>
            </div>
        </div>
        <div class="facilities_details_date">
          ...
          <div>
            <span>@ $125.00/each Tax 9.38</span>
          </div>
        </div> 
    </div>
    ...
    <div class="boooking_details_data data_second">
          ...
          <div><h3>Add on Total</h3></div>
          <div><h5>$2,500.00</h5></div>
          <div><h3>Add on Tax</h3></div>
          <div><h5>$75.00</h5></div>
          <div><h3>Total</h3></div>
          <div><h5>$5,091.52</h5></div>
          <div><h3>Guest Name</h3></div>
          <div><h5>rihaan</h5></div>
          <div><h3>Address</h3></div>
          <div><h5>rohini</h5></div>
          <div><h3>Address</h3></div>
          <div><h5>rohini 24</h5></div>
          <div><h3>City</h3></div>
          <div><h5>delhi</h5></div>
          <div><h3>State/Province</h3></div>
          <div><h5>delhi</h5></div>
          <div><h3>Zip/Postal Code</h3></div>
          <div><h5>111111 india</h5></div>
          <div><h3>E-mail Address</h3></div>
          <div><h5>amit@employee.com</h5></div>
          <div><h3>Phone</h3></div>
          <div><h5>11111111111</h5></div>
          <div><h3>Mobile Phone</h3></div>
          <div><h5>1111111111</h5></div>
    ...
    <div class="booking_policy">
       ...
       <div class="form-check">
        <label class="form-check-label">
          <input type="checkbox" class="form-check-input" value="">I have read and understood the hotel's Reservation Policies and agree with all terms and conditions outlined within.
        </label>
      </div>
